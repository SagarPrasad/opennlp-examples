...
public class CustomNERTesting {
    ...
    public void testColorFinder() {
    	...
    	String document = "Indian flag consist of orange, white, green color";
    	
    	List<String> docArray = new ArrayList<String>();
    	docArray.add(document);
    	docArray.add("Her blue eyes are beatuiful.");
    	docArray.add("Her eyes are japanese carmine.");
    	docArray.add("I love white car");
